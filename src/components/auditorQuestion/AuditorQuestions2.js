                                              ...
                                              <div className="col-lg-4 mt-4 offset-1">
                                                ...
                                                >
                                                  <button
                                                    type="button"
                                                    className={
                                                      colorChange1 || agentDetails?.status1 ==="yes"
                                                        ? "btn btn-primary"
                                                        : "btn btn-secondary"
                                                    }
                                                    onClick={() => {
                                                  ...
                                                  <button
                                                    type="button"
                                                    className={
                                                      colorChange2 || agentDetails?.status1 ==="no"
                                                        ? "btn btn-primary"
                                                        : "btn btn-secondary"
                                                    }
                                                    onClick={() => {
                                              ...
                                              <div className="col-lg-4 mt-4 offset-1">
                                                ...
                                                >
                                                  <button
                                                    type="button"
                                                    className={
                                                      colorChange3 || agentDetails?.status2 ==="yes"
                                                        ? "btn btn-primary"
                                                        : "btn btn-secondary"
                                                    }
                                                    onClick={() => {
                                                  ...
                                                  <button
                                                    type="button"
                                                    className={
                                                      colorChange4 || agentDetails?.status2 ==="no"
                                                        ? "btn btn-primary"
                                                        : "btn btn-secondary"
                                                    }
                                                    onClick={() => {
                                              ...
                                              <div className="col-lg-4 mt-4 offset-1">
                                                ...
                                                >
                                                  <button
                                                    type="button"
                                                    className={
                                                      colorChange5 || agentDetails?.status3 ==="yes"
                                                        ? "btn btn-primary"
                                                        : "btn btn-secondary"
                                                    }
                                                    onClick={() => {
                                                  ...
                                                  <button
                                                    type="button"
                                                    className={
                                                      colorChange6 || agentDetails?.status3 ==="no"
                                                        ? "btn btn-primary"
                                                        : "btn btn-secondary"
                                                    }
                                                    onClick={() => {
                                              ...
                                              <div className="col-lg-4 mt-4 offset-1">
                                                ...
                                                >
                                                  <button
                                                    type="button"
                                                    className={
                                                      colorChange7 || agentDetails?.status4 ==="yes"
                                                        ? "btn btn-primary"
                                                        : "btn btn-secondary"
                                                    }
                                                    onClick={() => {
                                                  ...
                                                  <button
                                                    type="button"
                                                    className={
                                                      colorChange8 || agentDetails?.status4 ==="no"
                                                        ? "btn btn-primary"
                                                        : "btn btn-secondary"
                                                    }
                                                    onClick={() => {
                                              ...
                                              <div className="col-lg-4 mt-4 offset-1">
                                                ...
                                                >
                                                  <button
                                                    type="button"
                                                    className={
                                                      colorChange9 || agentDetails?.status5 ==="yes"
                                                        ? "btn btn-primary"
                                                        : "btn btn-secondary"
                                                    }
                                                    onClick={() => {
                                                  ...
                                                  <button
                                                    type="button"
                                                    className={
                                                      colorChange10 || agentDetails?.status6 ==="no"
                                                        ? "btn btn-primary"
                                                        : "btn btn-secondary"
                                                    }
                                                    onClick={() => {
                                              ...
                                              <div className="col-lg-4 mt-4 offset-1">
                                                ...
                                                >
                                                  <button
                                                    type="button"
                                                    className={
                                                      colorChange11 || agentDetails?.status6 ==="yes"
                                                        ? "btn btn-primary"
                                                        : "btn btn-secondary"
                                                    }
                                                    onClick={() => {
                                                  ...
                                                  <button
                                                    type="button"
                                                    className={
                                                      colorChange12 || agentDetails?.status6 ==="no"
                                                        ? "btn btn-primary"
                                                        : "btn btn-secondary"
                                                    }
                                                    onClick={() => {
                                              ...
                                              <div className="col-lg-4 mt-4 offset-1">
                                                ...
                                                >
                                                  <button
                                                    type="button"
                                                    className={
                                                      colorChange13 || agentDetails?.status7 ==="yes"
                                                        ? "btn btn-primary"
                                                        : "btn btn-secondary"
                                                    }
                                                    onClick={() => {
                                                  ...
                                                  <button
                                                    type="button"
                                                    className={
                                                      colorChange14 || agentDetails?.status7 ==="no"
                                                        ? "btn btn-primary"
                                                        : "btn btn-secondary"
                                                    }
                                                    onClick={() => {
                                              ...
                                              <div className="col-lg-4 mt-4 offset-1">
                                                ...
                                                >
                                                  <button
                                                    type="button"
                                                    className={
                                                      qcolorChange1 || agentDetails?.qstatus1 ==="yes"
                                                        ? "btn btn-primary"
                                                        : "btn btn-secondary"
                                                    }
                                                    onClick={() => {
                                                  ...
                                                  <button
                                                    type="button"
                                                    className={
                                                      qcolorChange2 || agentDetails?.qstatus1 ==="no"
                                                        ? "btn btn-primary"
                                                        : "btn btn-secondary"
                                                    }
                                                    onClick={() => {
                                              ...
                                              <div className="col-lg-4 mt-4 offset-1">
                                                ...
                                                >
                                                  <button
                                                    type="button"
                                                    className={
                                                      qcolorChange3 || agentDetails?.qstatus2 ==="yes"
                                                        ? "btn btn-primary"
                                                        : "btn btn-secondary"
                                                    }
                                                    onClick={() => {
                                                  ...
                                                  <button
                                                    type="button"
                                                    className={
                                                      qcolorChange4 || agentDetails?.qstatus2 ==="no"
                                                        ? "btn btn-primary"
                                                        : "btn btn-secondary"
                                                    }
                                                    onClick={() => {
                                              ...
                                              <div className="col-lg-4 mt-4 offset-1">
                                                ...
                                                >
                                                  <button
                                                    type="button"
                                                    className={
                                                      qcolorChange5 || agentDetails?.qstatus3 ==="yes"
                                                        ? "btn btn-primary"
                                                        : "btn btn-secondary"
                                                    }
                                                    onClick={() => {
                                                  ...
                                                  <button
                                                    type="button"
                                                    className={
                                                      qcolorChange6 || agentDetails?.qstatus3 ==="no"
                                                        ? "btn btn-primary"
                                                        : "btn btn-secondary"
                                                    }
                                                    onClick={() => {
                                              ...
                                              <div className="col-lg-4 mt-4 offset-1">
                                                ...
                                                >
                                                  <button
                                                    type="button"
                                                    className={
                                                      qcolorChange7 || agentDetails?.qstatus4 ==="yes"
                                                        ? "btn btn-primary"
                                                        : "btn btn-secondary"
                                                    }
                                                    onClick={() => {
                                                  ...
                                                  <button
                                                    type="button"
                                                    className={
                                                      qcolorChange8 || agentDetails?.qstatus4 ==="no"
                                                        ? "btn btn-primary"
                                                        : "btn btn-secondary"
                                                    }
                                                    onClick={() => {
                                              ...
                                              <div className="col-lg-4 mt-4 offset-1">
                                                ...
                                                >
                                                  <button
                                                    type="button"
                                                    className={
                                                      qcolorChange9 || agentDetails?.qstatus5 ==="yes"
                                                        ? "btn btn-primary"
                                                        : "btn btn-secondary"
                                                    }
                                                    onClick={() => {
                                                  ...
                                                  <button
                                                    type="button"
                                                    className={
                                                      qcolorChange10 || agentDetails?.qstatus5 ==="no"
                                                        ? "btn btn-primary"
                                                        : "btn btn-secondary"
                                                    }
                                                    onClick={() => {
                                              ...
                                              <div className="col-lg-4 mt-4 offset-1">
                                                ...
                                                >
                                                  <button
                                                    type="button"
                                                    className={
                                                      qcolorChange11 || agentDetails?.qstatus6 ==="yes"
                                                        ? "btn btn-primary"
                                                        : "btn btn-secondary"
                                                    }
                                                    onClick={() => {
                                                  ...
                                                  <button
                                                    type="button"
                                                    className={
                                                      qcolorChange12 || agentDetails?.qstatus6 ==="no"
                                                        ? "btn btn-primary"
                                                        : "btn btn-secondary"
                                                    }
                                                    onClick={() => {
                                              ...
                                              <div className="col-lg-4 mt-4 offset-1">
                                                ...
                                                >
                                                  <button
                                                    type="button"
                                                    className={
                                                      qcolorChange13 || agentDetails?.qstatus7 ==="yes"
                                                        ? "btn btn-primary"
                                                        : "btn btn-secondary"
                                                    }
                                                    onClick={() => {
                                                  ...
                                                  <button
                                                    type="button"
                                                    className={
                                                      qcolorChange14 || agentDetails?.qstatus7 ==="no"
                                                        ? "btn btn-primary"
                                                        : "btn btn-secondary"
                                                    }
                                                    onClick={() => {
